...
export const CENTRES = {
  ...
  laserwall: { build(b) {
    for (let i = 0; i < 4; i++) b.laser(V3(-18 + i * 12, 25.5, -4), 8, { yaw: 0, pitch: -0.12, spread: 0.32, meta: { group: 'wall', u: i / 3 } });
    b.strip(pathLine(P3(-23, 25.5), P3(23, 25.5), 92), 0.34, 'bar');
    for (let i = 0; i < 2; i++) b.laser(V3(-12 + i * 24, 6, -4), 6, { pitch: 0.45, spread: 0.5, meta: { group: 'floor', u: i } });
  } },
  spiral: { build(b) {
